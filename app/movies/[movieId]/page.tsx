          ...
          <div className="relative min-h-[200px]">
            {movie.backdrop_path ? (
              <>
                ...
                <Image
                  className="object-cover w-full md:h-[600px] h-screen"
            ...
            <div className="absolute top-0 bottom-0 left-0 w-full">
              <div className="container h-full">
                <div className="flex flex-col gap-5 lg:w-1/2 h-full justify-center text-white">
                  <h1 className="text-4xl italic">{movie.original_title}</h1>
